...
## For all types
1. Train a classifier that predicts NA values from other predictors. Increases dependencies between predictors.
...
We can compare the strategies in terms of the AUC in a logistic regression. All variables are tested alone for their predictiveness using different strategies.
...
```{r}
categorical = c("int_student","ethnicity","first_generation","father_edu_level_code","mother_edu_level_code",  "low_income","ell","single_parent","foster_care","household_size_app","sport_at_admission","cal_res_at_app")
